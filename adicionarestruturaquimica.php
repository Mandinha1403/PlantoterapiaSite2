...
<html>
    ...
    <body>
        ...
        <div class="adicionarplanta">
            ...
            <div class="item"> <input type="text" id="nomeplanta" name="nomeplanta" placeholder="Insira o nome da estrutura química"> </div>
            <div class="item"> <textarea name="informacoes" cols="40" rows="10" placeholder="Insire as informações sobre a estrutura química"></textarea> </div>
